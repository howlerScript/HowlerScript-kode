...
-- Настройки кнопки ESP
espButton.Size = UDim2.new(0, 180, 0, 40)
espButton.Position = UDim2.new(0, 10, 0, 10)
espButton.Text = "ESP"
espButton.Parent = menuFrame

-- Настройки кнопки Chams
chamsButton.Size = UDim2.new(0, 180, 0, 40)
chamsButton.Position = UDim2.new(0, 10, 0, 60)
chamsButton.Text = "Chams"
chamsButton.Parent = menuFrame

-- Настройки кнопки Выход
exitButton.Size = UDim2.new(0, 180, 0, 40)
exitButton.Position = UDim2.new(0, 10, 0, 110)
exitButton.Text = "Выход"
exitButton.Parent = menuFrame

-- Функциональность кнопки Выход
exitButton.MouseButton1Click:Connect(function()
    screenGui:Destroy()
end)

-- Здесь можно добавить обработчики событий для кнопок ESP и Chams
