...
do
	...
	EzHub.TextLabel_8.Text = "Hello happygeneral2015, Thank you for using HowaHub"
...
terminalPrint("Loading Terminal...", "y");

local commands = {};	-- stores all commands and their functions
local tips = {
	"Terminal is CMD merged with HowaHub. This was only done because of the amount of users that wished to see CMD being worked on again.",
	"Terminal allows you to access many functions of Hub that you won't be able to access with a GUI button.",
	"Type cmdlist or one of it's aliases to view all the possible commands.",
	"Hub and the terminal is fully open source! Go to the Github repo to view the source."
};
...
terminalPrint("Loaded HowaHub Terminal successfully...", "b");
